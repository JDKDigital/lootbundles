...
public class ModItems
{
    ...
    public static final RegistryObject<Item> FRAGMENT = ITEMS.register("fragment", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> LOOT_BUNDLE = ITEMS.register("loot_bundle", () -> new LootBundle(new Item.Properties()));
}
